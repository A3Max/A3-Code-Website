...
export default function Navbar() {
  ...
  return (
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <Link href="/" className="flex flex-col items-center group">
                ...
                <span className="text-lg font-bold text-black w-full text-center tracking-[0.15em]">Coder</span>
              </Link>
            </div>
    ...
    {/* Mobile Menu Drawer */}
    <div 
      className={`fixed inset-y-0 left-0 z-50 w-[280px] bg-[#e4e4e4] border-r border-black/10 transition-transform duration-300 ease-in-out lg:hidden ${
