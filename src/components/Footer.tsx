            ...
            <form onSubmit={handleNewsletterSubmit} className="max-w-md">
              <div className="flex gap-2">
                ...
                <input
                  ...
                  className="flex-1 px-4 py-2 bg-white/5 border border-white/10 text-white placeholder:text-white/50 focus:outline-none focus:border-[#306bff] transition-colors"
                  disabled={status === 'loading'}
                />
                <button
                  type="submit"
                  disabled={status === 'loading'}
                  className="px-6 py-2 bg-[#306bff] text-white font-medium hover:bg-[#2555e6] transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                >
              ...
              <p className="text-xs text-white/50 mt-2">
                ...
                <Link href={footerConfig.legal.privacy} className="hover:text-white transition-colors">
                  Privacy Policy
                </Link>
              </p>
            </form>
