...
export default function Footer() {
  ...
  return (
    <footer className="bg-[#e4e4e4] border-t border-black/10">
      <div className="lg:pl-[280px] px-6 py-8 pr-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-4">
          <div>
            <div className="flex items-baseline gap-2 mb-4">
              ...
              />
              <span className="text-xl font-bold text-[#1a1a1a]">Coder</span>
            </div>
          ...
          <div>
            <h3 className="text-sm font-semibold text-[#1a1a1a] mb-4">Navigation</h3>
          ...
          <div>
            <h3 className="text-sm font-semibold text-[#1a1a1a] mb-4">Support</h3>
            <ul className="space-y-2">
          ...
          <div>
            <h3 className="text-sm font-semibold text-[#1a1a1a] mb-4">Connect</h3>
            ...
            {footerConfig.contact.email && (
              <a 
                ...
                className="text-sm text-black/60 hover:text-[#1a1a1a] transition-colors block mb-2"
              >
                {footerConfig.contact.email}
              </a>
            )}
            ...
            {footerConfig.newsletter.enabled && (
              <div className="mt-6">
                <h3 className="text-sm font-semibold text-[#1a1a1a] mb-4">Subscribe to our newsletter</h3>
                <form onSubmit={handleNewsletterSubmit}>
                  <div className="flex gap-2">
                    ...
                    <input
                      ...
                      className="flex-1 px-4 py-2 bg-white border border-black/10 text-[#1a1a1a] placeholder:text-black/50 focus:outline-none focus:border-[#306bff] transition-colors shadow-lg"
                      disabled={status === 'loading'}
                    />
                    <button
                      type="submit"
                      disabled={status === 'loading'}
                      className="px-6 py-2 bg-[#306bff] text-white font-medium hover:bg-[#2555e6] transition-colors disabled:opacity-50 disabled:cursor-not-allowed shadow-lg"
                    >
        ...
        <div className="border-t border-black/10 pt-4 pr-12">
