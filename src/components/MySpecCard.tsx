...
export default function MySpecCard({ title, category, tier, date, duration, likes, comments, thumbnail, description, index = 0, hoveredIndex, onMouseEnter, onMouseLeave }: MySpecCardProps) {
  ...
  return (
    ...
    >
      ...
      <div className="flex">
        ...
        <div className="flex-1 pl-3 pr-0.5">
          <h4 className="text-sm font-semibold text-white leading-tight mb-3 line-clamp-3">{title}</h4>
