...
export default function MySpecCard({ id, title, category, tier, date, duration, likes, comments, thumbnail, description, index = 0, hoveredIndex, onMouseEnter, onMouseLeave, isOwner = false, onDelete }: MySpecCardProps) {
