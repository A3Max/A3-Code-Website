      ...
      <main className="pt-24">
        ...
        <div className="max-w-md mx-auto px-6">
          <div className="bg-[#e4e4e4] shadow-lg border border-black/10 p-8 hover:border-[#306bff]/50 transition-colors relative">
            ...
            <p className="text-sm text-black/60 mb-6">Enter your credentials to access your account</p>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                ...
                <div className="text-right mt-1">
                  <Link href="/forgot-password" className="text-sm text-[#306bff] hover:underline">
                    Forgot password?
                  </Link>
                </div>
              </div>
              ...
              <div className="relative my-6">
                ...
                <div className="relative flex justify-center text-sm">
                  <span className="px-4 bg-[#e4e4e4] text-black/60">OR CONTINUE WITH</span>
                </div>
              </div>
              ...
              <button
                ...
                className="w-full px-6 py-4 text-lg font-semibold bg-white border border-black/10 text-[#1a1a1a] hover:border-[#306bff]/50 transition-colors flex items-center justify-center gap-3 shadow-lg"
              >
