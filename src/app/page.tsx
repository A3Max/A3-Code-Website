      ...
      <main className="pt-24">
        <div className="max-w-7xl mx-auto px-6 py-20">
          <div className="flex flex-col lg:flex-row gap-12">
            ...
            <div className="lg:w-[450px]">
              ...
              <div className="mt-6">
                <div className="bg-white/5 border border-white/10 px-4 py-4 h-32 relative">
                  ...
                  <div className="flex items-center justify-between h-full gap-4 pt-4">
                    <div className="flex flex-col items-center justify-center gap-1 flex-1">
                      ...
                      <span className="text-xs text-white/70 font-medium">macOS</span>
                      <span className="text-[10px] text-white/50">Intel & Apple Silicon</span>
                    </div>
                    <div className="flex flex-col items-center justify-center gap-1 flex-1">
                      <svg className="w-8 h-8 text-white/70" viewBox="0 0 24 24" fill="currentColor">
                        <path d="M0 3.449L9.75 2.1v9.451H0m10.949-9.602L24 0v11.4H10.949M0 12.6h9.75v9.451L0 20.699M10.949 12.6H24V24l-12.9-1.801"/>
                      </svg>
                      <span className="text-xs text-white/70 font-medium">Windows</span>
                      <span className="text-[10px] text-white/50">x64 & ARM</span>
                    </div>
                    <div className="flex flex-col items-center justify-center gap-1 flex-1">
                      <svg className="w-8 h-8 text-white/70" viewBox="0 0 24 24" fill="currentColor">
                      ...
                      <span className="text-xs text-white/70 font-medium">Linux</span>
                      <span className="text-[10px] text-white/50">x64 & ARM</span>
                    </div>
                    <div className="flex flex-col items-center justify-center gap-1 flex-1">
                      <svg className="w-8 h-8 text-white/70" viewBox="0 0 24 24" fill="currentColor">
                      ...
                      <span className="text-xs text-white/70 font-medium">NVIDIA DGX</span>
                      <span className="text-[10px] text-white/50">Spark Compatible</span>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <div className="max-w-7xl mx-auto px-6 py-12">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 max-w-4xl mx-auto">
            <a href="https://reddit.com" target="_blank" rel="noopener noreferrer" className="bg-white/5 border border-white/10 p-4 hover:border-[#306bff]/50 transition-colors flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-xs text-white/50">Join our community</p>
              </div>
            </a>
            <a href="https://discord.com" target="_blank" rel="noopener noreferrer" className="bg-white/5 border border-white/10 p-4 hover:border-[#306bff]/50 transition-colors flex items-center gap-4">
              <svg className="w-8 h-8 text-white/70 flex-shrink-0" viewBox="0 0 24 24" fill="currentColor">
            ...
            <a href="https://youtube.com" target="_blank" rel="noopener noreferrer" className="bg-white/5 border border-white/10 p-4 hover:border-[#306bff]/50 transition-colors flex items-center gap-4">
              <svg className="w-8 h-8 text-white/70 flex-shrink-0" viewBox="0 0 24 24" fill="currentColor">
                <path d="M23.498 6.186a3.016 3.016 0 0 0-2.122-2.136C19.505 3.545 12 3.545 12 3.545s-7.505 0-9.377.505A3.017 3.017 0 0 0 .502 6.186C0 8.07 0 12 0 12s0 3.93.502 5.814a3.016 3.016 0 0 0 2.122 2.136c1.871.505 9.376.505 9.376.505s7.505 0 9.377-.505a3.015 3.015 0 0 0 2.122-2.136C24 15.93 24 12 24 12s0-3.93-.502-5.814zM9.545 15.568V8.432L15.818 12l-6.273 3.568z"/>
              </svg>
              <div>
                <span className="text-white font-medium">YouTube</span>
                <p className="text-xs text-white/50">Watch tutorials</p>
              </div>
            </a>
            <a href="https://linkedin.com" target="_blank" rel="noopener noreferrer" className="bg-white/5 border border-white/10 p-4 hover:border-[#306bff]/50 transition-colors flex items-center gap-4">
              <svg className="w-8 h-8 text-white/70 flex-shrink-0" viewBox="0 0 24 24" fill="currentColor">
                <path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"/>
              </svg>
              <div>
                <span className="text-white font-medium">LinkedIn</span>
                <p className="text-xs text-white/50">Connect with us</p>
              </div>
            </a>
            <a href="https://twitter.com" target="_blank" rel="noopener noreferrer" className="bg-white/5 border border-white/10 p-4 hover:border-[#306bff]/50 transition-colors flex items-center gap-4">
              <svg className="w-8 h-8 text-white/70 flex-shrink-0" viewBox="0 0 24 24" fill="currentColor">
                <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/>
              </svg>
              <div>
                <span className="text-white font-medium">Twitter</span>
                <p className="text-xs text-white/50">Follow for updates</p>
              </div>
            </a>
            <a href="https://github.com" target="_blank" rel="noopener noreferrer" className="bg-white/5 border border-white/10 p-4 hover:border-[#306bff]/50 transition-colors flex items-center gap-4">
              <svg className="w-8 h-8 text-white/70 flex-shrink-0" viewBox="0 0 24 24" fill="currentColor">
              ...
              <div>
                ...
                <p className="text-xs text-white/50">View our code</p>
              </div>
            </a>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-6 py-20">
          <div className="text-center mb-12">
                  <h2 className="text-4xl font-bold text-white mb-4">Built for real engineering output</h2>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                  <div className="bg-white/5 border border-white/10 p-6 hover:border-[#306bff]/50 transition-colors">
                    <div className="flex items-start gap-4">
                      ...
                      <div className="flex-1">
                        <h3 className="text-lg font-semibold text-white mb-2">From Paper to Production</h3>
                  ...
                  <div className="bg-white/5 border border-white/10 p-6 hover:border-[#306bff]/50 transition-colors">
                    <div className="flex items-start gap-4">
                      ...
                      <div className="flex-1">
                        <h3 className="text-lg font-semibold text-white mb-2">Plan Before You Execute</h3>
                        <p className="text-sm text-white/70 mb-4">
                  ...
                  <div className="bg-white/5 border border-white/10 p-6 hover:border-[#306bff]/50 transition-colors">
                    <div className="flex items-start gap-4">
                      ...
                      <div className="flex-1">
                        <h3 className="text-lg font-semibold text-white mb-2">Model Freedom, Zero Lock-in</h3>
                        <p className="text-sm text-white/70 mb-4">
                  ...
                  <div className="bg-white/5 border border-white/10 p-6 hover:border-[#306bff]/50 transition-colors">
                    <div className="flex items-start gap-4">
                      ...
                      <div className="flex-1">
                        <h3 className="text-lg font-semibold text-white mb-2">MCP-Powered Data Access</h3>
                        <p className="text-sm text-white/70 mb-4">
                  ...
                  <div className="bg-white/5 border border-white/10 p-6 hover:border-[#306bff]/50 transition-colors">
                    <div className="flex items-start gap-4">
                      ...
                      <div className="flex-1">
                        <h3 className="text-lg font-semibold text-white mb-2">Executes Like a Senior Engineer</h3>
                        <p className="text-sm text-white/70 mb-4">
                  ...
                  <div className="bg-white/5 border border-white/10 p-6 hover:border-[#306bff]/50 transition-colors">
                    <div className="flex items-start gap-4">
                      ...
                      <div className="flex-1">
                        <h3 className="text-lg font-semibold text-white mb-2">Built for Quantitative Work</h3>
                        <p className="text-sm text-white/70 mb-4">
        ...
        <div className="max-w-7xl mx-auto px-6 py-20">
          <div className="text-center mb-12">
            <h2 className="text-4xl font-bold text-white mb-4">Works with leading LLM providers</h2>
            <p className="text-lg text-white/70 max-w-2xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-3xl mx-auto">
            <a href="https://tensorix.ai" target="_blank" rel="noopener noreferrer" className="bg-white/5 border border-white/10 p-6 hover:border-[#306bff]/50 transition-colors flex items-center gap-4">
              <div className="flex-shrink-0 w-12 h-12 bg-[#306bff] rounded-lg flex items-center justify-center">
                <span className="text-white font-bold text-sm">TX</span>
              </div>
              <div>
                <h3 className="text-lg font-semibold text-white">Tensorix</h3>
                <p className="text-sm text-white/50">tensorix.ai</p>
              </div>
            </a>

            <a href="https://openrouter.ai" target="_blank" rel="noopener noreferrer" className="bg-white/5 border border-white/10 p-6 hover:border-[#306bff]/50 transition-colors flex items-center gap-4">
              <div className="flex-shrink-0 w-12 h-12 bg-[#306bff] rounded-lg flex items-center justify-center">
                <span className="text-white font-bold text-sm">OR</span>
              </div>
              <div>
                <h3 className="text-lg font-semibold text-white">OpenRouter</h3>
                <p className="text-sm text-white/50">openrouter.ai</p>
              </div>
            </a>
          </div>
        </div>
